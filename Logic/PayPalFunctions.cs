...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-vqcba3818212_api1.business.example.com";
    private string APIPassword = "HLH9CTXDZZQ93FT8";
    private string APISignature = "A3a1nKXGdVr68tqqQ8tFCgXJxlpxALJzNFfvqRXHDM9KTyqn1ws9lDyP";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "E_shop_books Sample Application";
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            //log the exeptione.
            E_shop_books.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
